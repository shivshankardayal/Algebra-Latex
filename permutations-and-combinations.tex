...
Now let $r$ be a non-negative integer. By an $r$-\textit{combination} of a set $S$ of $n$ elements, we understand an unordered
...
The following facts are easy to figure out for each non-negative integer $n$ $${0\choose 0} = {n\choose 0} = {n\choose n} = 1, {n\choose 1} = n,$$
