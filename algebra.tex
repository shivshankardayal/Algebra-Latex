...
%\include{theory-of-equations}
%\include{permutations-and-combinations}
%\include{mathematical-induction}
%\include{binomials-multinomials-expansions}
%\include{determinants}
%\include{matrices}
\include{inequalities}
\part{Solutions}
\include{logarithm-solutions}
\backmatter
\include{fdl}
\printindex
\end{document}
