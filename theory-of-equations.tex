...
\item If $\alpha, \beta$ are the roots of the equation $ax^2 + bx + c = 0$ and $\alpha_1, -\beta$ are those of equation $a_1x^2 +
  b_1x + c_1 = 0$, show that $\alpha, \alpha_1$ are the roots of the equation $$\frac{x^2}{\frac{b}{a} + \frac{b_1}{a_2}} + x
  +\frac{1}{\frac{b}{c} + \frac{b_1}{c_2}} = 0$$.
...
\item Find the values of $m$ for which boththe roots of the equation $x^2 - 2mx + m^2 - 1 = 0$ lie between $-2$ and $4$.
\end{enumerate}
